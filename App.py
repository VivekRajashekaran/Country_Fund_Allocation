...
def main():
    ...
    st.subheader("A Machine Learning Model to predict required fund allocation for a countrt")
    ...
    inp_list=[[child_mor,exports,health,imports,inflation,lf_exp,tol_fer,gdp]]
